...
def make_args_list(n_trials, dataset_names, algorithms, n_hparams_from, n_hparams, steps,
    data_dir, task, holdout_fraction, single_test_envs, hparams, data_augmentation,
    model_arch, transfer):
    args_list = []
            ...
            for algorithm in algorithms:
                ...
                for test_envs in all_test_envs:
                    for hparams_seed in range(n_hparams_from, n_hparams):
                        ...
                        train_args['data_augmentation'] = data_augmentation
                        if not (model_arch == 'resnet50' and not transfer):
                            train_args['model_arch'] = model_arch
                            train_args['transfer'] = transfer
