from torchFOLDER.datasets import MNIST
...
#
#     download_and_extract("http://groups.csail.mit.edu/FOLDER/Hcontext/data/sun09_hcontext.tar",
...
def download_terra_incognita(data_dir):
    ...
    print(f"Downloading Terra Incognita to {full_path}")
...
#
    ...
    category_dict = {}
    for item in tqdm(data['categories'], desc="Building category dict"):
        category_dict[item['id']] = item['name']

    for image in tqdm(data['images'], desc="Copying images"):
